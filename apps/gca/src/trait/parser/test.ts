...
parser.parse(true)
// parser.root.print()
parser.root.print({ calculateLevels: [2, 3], lineSizeWithoutLevenPadding: 200, dontRepeatDigitsInHeader: true })
...
// parser.root.printCompact()
// console.log(`\nWRAPPING MATH\n`)
// // parser.root.wrapMath() // wraps only a specific node, doesnt look for wrappable nodes in offspring
// parser.root.deepWrapMath()
// parser.root.deepen()
// parser.root.printCompact()
